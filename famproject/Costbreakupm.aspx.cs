...
public partial class Costbreakup : System.Web.UI.Page
{
    ...
    {
        cmd = new SqlCommand("insert into subassets values(@SubId,@Assetname,@SID,@SNM,@AssPrc,@MFGDt,@InstDt,@life,@assetid)", cn);
        ...
        cmd.Parameters.AddWithValue("@Assetid", Label4.Text);
