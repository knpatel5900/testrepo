<%@ Page Title="" Language="C#" MasterPageFile="~/fam1.master" AutoEventWireup="true" CodeFile="Addassets.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <table cellspacing="2px" cellpadding="3px">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBox1" runat="server"  CssClass="txt" placeholder="Enter Asset ID" Height="30px" Width="207px"></asp:TextBox>
                    </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBox5" runat="server"  CssClass="txt" placeholder="Enter Asset Name" Height="30px" Width="207px"></asp:TextBox>
                </td>
                <td>
                    <b>Supplier Name:</b>
                </td>
