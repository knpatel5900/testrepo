<%@ Page Title="" Language="C#" MasterPageFile="~/fam1.master" AutoEventWireup="true" CodeFile="Depreactionm.aspx.cs" Inherits="Default2" %>
 ...
 <td><b>Department</b></td>
            ...
            <td>
                <asp:Button ID="Button1" runat="server" Text="View Asset" 
                    ...
                    BackColor=DodgerBlue Font-Bold="true" ForeColor="AntiqueWhite"  /></td></tr>
            </table>
            </center><center>
    ...
    BorderStyle="None" BorderWidth="1px" CellPadding="3">
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton2" runat="server" oncommand="LinkButton2_Command">SAVE</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
