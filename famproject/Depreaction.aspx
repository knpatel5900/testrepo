<%@ Page Title="" Language="C#" MasterPageFile="~/fam1.master" AutoEventWireup="true" CodeFile="Depreaction.aspx.cs" Inherits="Default2" %>
    ...
    BorderStyle="None" BorderWidth="1px" CellPadding="3">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Calculate Depteaction">
                <ItemTemplate>
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="icon%20images/search.gif"
